package com.yunbo.jni.proxy_tools;
...
public class RC4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("加密结果 "+RC4.encrypt(data, ACCESSKEY));
        System.out.println("解密结果 "+RC4.decrypt(RC4.encrypt(data, ACCESSKEY), ACCESSKEY));
    }
}